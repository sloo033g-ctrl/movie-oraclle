...
> A retro-minimalist Hollywood oracle that predicts the fate of any movie concept — powered by Claude AI.
...
*Built with [Claude](https://claude.ai) · Anthropic API · Vite + React*
